...
const zhHant = {
  ...
  tangoAlt: '夜裡的行動室，戴眼鏡的棕髮男生在筆電前駭進系統，黑髮女生在他身後破解一面發光的保安面板。',
  ...
  loversAlt: '粉紅色的圓形太空船裡，黑髮女生在上層轉動船舵，戴眼鏡的棕髮男生在下層操作護盾，窗外是星空和一顆行星。',
  ...
  heavenlyAlt: '太空站的走道裡，戴眼鏡的棕髮男生和黑髮女生一上一下漂浮著，中間的圓窗外是地球，兩人笑得很開心。',
...
export const copy: Record<Language, Record<CopyKey, string>> = {
  ...
  en: {
    ...
    activityUnpick: "Leave it open for now",
    ...
    tangoAlt: 'A night-lit ops room: a brown-haired boy with browline glasses hacks at a laptop while his black-haired teammate cracks a glowing security panel behind him.',
    ...
    loversAlt: 'Inside a round pink spaceship, a black-haired girl turns the ship’s wheel on the upper deck while a brown-haired boy with browline glasses runs the shield below. Stars and a planet show through the hull.',
    ...
    heavenlyAlt: 'A brown-haired boy with browline glasses and a black-haired girl float one above the other along a space-station corridor, the Earth in the round window between them. Both are laughing.',
