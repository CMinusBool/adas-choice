 ...
 * whole, so its stage is 1408 x 792 (ticket 89), and the Activity Room's
 * backdrop is scaled × 0.83 so its painted doorway is the one door, 142 x 350
 * units, and its stage is 1328 x 747 (96). Two things outside the model repeat
